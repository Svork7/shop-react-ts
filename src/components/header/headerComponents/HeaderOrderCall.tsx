  ...
  return (
    <HeaderOrderCallStl>
      <div className="wrapper">
        {!resize1000 && <PhoneSVG />}
        <div>
          <h4 className="title">Отдел продаж</h4>
          <div className="left">
            <span className="call">+7 (777) 490-00-91</span>
            <span className="call">время работы: 9:00-20:00</span>
            <span className="call">Заказать звонок</span>
          </div>
        </div>
      </div>
      {resize1000 ? (
